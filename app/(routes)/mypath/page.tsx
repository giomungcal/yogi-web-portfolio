      ...
      <main className="flex flex-col w-full gap-y-6 md:gap-y-0 md:flex-row h-full md:p-4 p-12 justify-between items-start md:items-end overflow-visible">
        <div className="flex flex-col md:w-[19%] h-full justify-between items-start overflow-visible">
          ...
          <div className="relative">
            <h1 className="text-[#470842] md:text-6xl text-8xl danfo-regular leading-[4.5rem] md:leading-[3rem] my-2 mb-6 md:mb-0">
              MY
              <br />
              PATH
            </h1>
        ...
        <div className="md:static md:flex md:items-end md:-mb-12 md:w-auto sm:flex hidden absolute top-0 right-8 mt-[-5.5rem] w-56">
          <motion.img
        ...
        <section className="flex flex-col justify-between h-full md:w-[43%] text-xs md:text-[10.5px] lg:text-[11px] kode-mono-light text-right">
          ...
          <div className="flex flex-col justify-end items-end kode-mono-regular w-full mt-4 md:mt-0 ">
            ...
            <p>
              back in 2020, i was working towards a career in front-end
              development. however..{" "}
            </p>
            ...
            <p>
              ...
              working as a mainframe administrator. in 2023, i was promoted to
              an assistant manager position. despite having a great job, after
              much consideration, i decided in 2024 to return to my roots and
              pursue development again.
            </p>
          </div>
        </section>
